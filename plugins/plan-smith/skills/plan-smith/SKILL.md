...
4. **User confirmation gate (never skip):** show the user the packet's essentials (goal / hard constraints / rejected alternatives / frame & style selection with rationale) and confirm via AskUserQuestion: "Here is the intent and constraints I distilled — is this correct?"
